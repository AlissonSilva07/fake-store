...
const Categories = () => {
  ...
  return (
    <div className='flex items-center gap-10'>
        ...
        <button className='flex items-center p-4 bg-fuchsia-900 w-60 h-20 rounded-xl border-4 border-white text-white hover:text-fuchsia-900 hover:bg-white hover:border-fuchsia-900 transition-all delay-75 relative overflow-hidden'>
            <div>
